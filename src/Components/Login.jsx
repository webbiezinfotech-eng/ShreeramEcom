        ...
        <div className="bg-white rounded-xl sm:rounded-2xl shadow-lg border border-gray-200 p-4 sm:p-6 lg:p-8">
          <form className="space-y-4 sm:space-y-6" onSubmit={handleSubmit}>
            ...
            <div className="grid grid-cols-2 gap-2 sm:gap-3">
              <button
                type="button"
                className="w-full inline-flex justify-center items-center py-2 sm:py-2.5 px-2 sm:px-4 border border-gray-300 rounded-lg shadow-sm bg-white text-xs sm:text-sm font-medium text-gray-500 hover:bg-gray-50 transition-colors"
              >
                ...
                <span className="ml-1.5 sm:ml-2 hidden sm:inline">Google</span>
              </button>
              <button
                type="button"
                className="w-full inline-flex justify-center items-center py-2 sm:py-2.5 px-2 sm:px-4 border border-gray-300 rounded-lg shadow-sm bg-white text-xs sm:text-sm font-medium text-gray-500 hover:bg-gray-50 transition-colors"
              >
                ...
                <span className="ml-1.5 sm:ml-2 hidden sm:inline">Facebook</span>
              </button>
            </div>
